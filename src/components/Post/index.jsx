                  ...
                  <div className="post-footer">
                    <div className="post-button-group shared-flex-content shared-button-padding">
                      <div className="post-button-group-left">
                        <span>
                          <button className="post-button-line button-reset">
                            {icons.like}
                          </button>
                        </span>
                        <span>
                          <button className="post-button-line post-button-center button-reset">
                            {icons.comment}
                          </button>
                        </span>
                        <span>
                    ...
                    <div className="shared-button-padding">
                      <a href="/" className="post-text-title">
                        <span>685 likes</span>
                      </a>
                    </div>
                    <div className="shared-button-padding">
                      ...
                      <div className="post-tags">
                        {article.tags?.map((tag, i) => (
                          <a
                            key={i}
                            href={tag.url}
                            className="post-text-tag post-tags-line"
                          >{`#${tag.name} `}</a>
                        ))}
                      </div>
                    </div>
                    <div className="shared-button-padding mb-x2">
                      <a href="/" className="post-text-title post-text-time">
                        <time dateTime="2022-03-16T09:03:36.000Z">
                          1 Days Ago
                        </time>
                      </a>
                    </div>
